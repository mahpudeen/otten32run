        ...
        <div id="main-wrapper" class="container">
          <div class="row">
            <div class="col-md-6 col-sm-6 col-12 mt-3 text-left">
              <p>Peserta yang belum ambil racepack : <b>{{posts.length}}</b> orang</p>
            </div>
  ...
  methods: {
    ...
    confirm(item) {
      ...
      Swal.fire({
        title: "Konfirmasi",
        text:
          "Apakah " + item.nama_lengkap + " sudah melakukan pengambilan racepack?",
        icon: "warning",
        ...
        if (result.value) {
          self.$http
            ...
            .then(function(res) {
              ...
              Swal.fire(
                "Berhasil!",
                item.nama_lengkap + " sudah melakukan pengambilan racepack!",
                "success"
              );
            })
            .catch(function(err) {
