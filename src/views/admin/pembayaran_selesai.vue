        ...
        <div id="main-wrapper" class="container">
          <div class="row">
            <div class="col-md-6 col-sm-6 col-12 mt-3 text-left">
              <p>Peserta yang sudah dikonfirmasi : <b>{{posts.length}}</b> orang</p>
            </div>
...
export default {
  ...
  methods: {
    ...
    getResults() {
      axios
        .get("http://35.187.253.244/api/public/users_sdhbayar/")
    ...
    confirm(item) {
      ...
      Swal.fire({
        title: "Konfirmasi",
        text:
          "Apakah yakin mau membatalkan status pembayaran " + item.nama_lengkap + " ?",
        icon: "warning",
        ...
        if (result.value) {
          self.$http
            .post("http://35.187.253.244/api/public/update_pembayaran/", param)
            .then(function(datas) {
              return datas;
            })
            .then(function(res) {
              ...
              Swal.fire(
                "Berhasil!",
                "Status pembayaran " +item.nama_lengkap + " dibatalkan!",
                "success"
              );
            })
            .catch(function(err) {
              ...
              Swal.fire(
                "Gagal!",
                "Status pembayaran "+ item.nama_lengkap + " gagal diupdate!",
                "error"
              );
            });
