<template>
        <section class="features mar-bottom" id="features">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="navy-line"></div>
                    <h1> SYARAT & KETENTUAN LOMBA <br> OTTEN32RUN 2020</h1>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    ...
                    <label><b>Peraturan Acara</b></label><br>
                    ...
                    <label><b>B. Ketentuan Peserta</b></label><br>
                    <ol>
                    ...
                    <label><b>C. Pengambilan Racepack</b></label><br>
                    <ol>
                    ...
                    <label><b>D. Penitipan Barang</b></label><br>
                    <ol>
                    ...
                    <label><b>E. Ketentuan Pemenang</b></label><br>
                    <ol>
